...
void RoutingFisheyePrintNeighborInfo( GlomoNode* node, GlomoRoutingFisheye* fisheye );
...
void RoutingFisheyeHandleNeighborTOMsg( GlomoNode* node, GlomoRoutingFisheye* fisheye );
