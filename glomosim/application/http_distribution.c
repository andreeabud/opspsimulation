...
/*
 * $Id: http_distribution.c,v 1.1 2000/01/10 09:09:34 gandy Exp $
 *
...
{
    int top =   count - 1, bottom = 0, current;
    ...
    while( TRUE ) {
        ...
        if( ( value >= array[current].cdf ) && ( value < array[current + 1].cdf ) ) {
#ifdef DEBUG
            printf( "DONE\n" );
#endif
            return current;
...
int                         HttpConsecutiveDocsDistLength   = 21 ;

// Indirection is needed to fool damaged linker

DoubleDistElement*          HttpConsecutiveDocsDistTable    = foo;
...
int                         HttpFilesPerDocumentDistLength  = 27 ;

// Indirection is needed to fool damaged linker

DoubleDistElement*          HttpFilesPerDocumentDistTable   = foo1;
...
int                         HttpPrimaryReplyDistLength      = 1133 ;

// Indirection is needed to fool damaged linker

DoubleDistElement*          HttpPrimaryReplyDistTable       = foo2;
...
int                         HttpPrimaryRequestDistLength    = 305 ;

// Indirection is needed to fool damaged linker

DoubleDistElement*          HttpPrimaryRequestDistTable     = foo3;
...
int                         HttpSecondaryReplyDistLength    = 1848 ;

// Indirection is needed to fool damaged linker

DoubleDistElement*          HttpSecondaryReplyDistTable     = foo4;
...
int                         HttpSecondaryRequestDistLength  = 286 ;

// Indirection is needed to fool damaged linker

DoubleDistElement*          HttpSecondaryRequestDistTable   = foo5;
...
int                         HttpThinkTimeDistLength         = 1649 ;

// Indirection is needed to fool damaged linker

DoubleDistElement*          HttpThinkTimeDistTable          = foo6;
