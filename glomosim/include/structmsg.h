 ...
 */
enum { /* Special message types used for internal design. */
MSG_SPECIAL_Broadcast,
MSG_SPECIAL_Timer, /* Message Types for Channel layer */
MSG_CHANNEL_FromChannel,
MSG_CHANNEL_FromRadio, /* Message Types for Radio layer */
MSG_RADIO_FromChannelBegin,
MSG_RADIO_FromChannelEnd,
MSG_RADIO_FromMac,
MSG_RADIO_StartPropagation,
MSG_RADIO_SwitchToIdle,
MSG_RADIO_CheckChannelStatus, /* Message Types for MAC layer */
...
MSG_MAC_SlotFront,
MSG_MAC_WiredToWired, /* Message Types for Network layer */
...
MSG_NETWORK_CheckNeighborTimeout, /* Messages Types special for IP */
MSG_NETWORK_BuffTimerExpired, /* Message Types for Transport layer */
...
MSG_TRANSPORT_Tcp_CheckTcpOutputTimer, /* Messages Types for Transport layer with NS TCP */
MSG_TCP_SetupConnection, /* Message Types for Appliation layer */
...
MSG_APP_TimerExpired, /* Messages Types for Application layer with UDP */
MSG_APP_FromTransport, /* Messages Types for Application layer with NS TCP */
MSG_APP_NextPkt,
MSG_APP_SetupConnection, /* Messages Type for Application layer directly on top of IP */
MSG_APP_FromNetwork, /* Message Types for Promiscuous Routing Algorithms */
MSG_ROUTE_FromTransport,
MSG_ROUTE_FromNetwork, /* Message Types for Routing - OSPF */
MSG_OspfScheduleHello,
MSG_OspfInitiateHello,
MSG_OspfScheduleLSA,
MSG_OspfOriginateLSA,
MSG_OspfRetransLSA,
MSG_OspfInactivityNeighFired, /* Message types for rumor */
MSG_RUMOR_Timeout,
MSG_RUMOR_ReconInitiate,
MSG_RUMOR_FileReference,
MSG_APP_FromRumor,
MSG_APP_FromRumorKillOut,
MSG_APP_FromRumorKillIn, /* Message types for routing - Bellmanford. */
MSG_APP_RTBroadcastAlarm,
MSG_APP_CheckTimeoutAlarm,
MSG_APP_TriggerUpdateAlarm, /* Message types for routing - Fisheye */
MSG_APP_FisheyeNeighborTimeout,
MSG_APP_FisheyeIntraUpdate,
MSG_APP_FisheyeInterUpdate, /* Message Types for Application Layer CBR */
MSG_APP_CBR_NEXT_PKT, /* Message Types for Setting Timers */
MSG_TRANSPORT_TCP_TIMER, /*Message Types Used in new version of aodv.pc implemented by Vrishali Wagle, Elizabeth Belding-Royer*/
