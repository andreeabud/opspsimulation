...
DUMMY, AODV_RREQ, AODV_RREP, AODV_RERR, AODV_RREP_ACK }  AODV_PacketType;
...
void RoutingAodvInsertNbrTable( GlomoNode* node,  GlomoCoordinates nbrPosition, NODE_ADDR nbrAddr );
...
#define _____________tianke_______________
