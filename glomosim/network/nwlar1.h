...
typedef enum { LAR1_ROUTE_REQUEST, LAR1_ROUTE_REPLY, LAR1_ROUTE_ERROR }  LAR1_PacketType;
...
//              nodeInput
//
void NetworkLar1Init( GlomoNode* node, GlomoNetworkLar1** lar1, const GlomoNodeInput* nodeInput );
...
//
Message* NetworkLar1RetrieveSendBuf( GlomoNetworkLar1* lar1, NODE_ADDR destAddr );
...
//
void NetworkLar1InsertRequestSeen( GlomoNetworkLar1* lar1, NODE_ADDR sourceAddr, int seqNum );
...
//
void NetworkLar1InsertRequestSent( GlomoNetworkLar1* lar1, NODE_ADDR destAddr );
...
// PARAMETERS   destAddr        - destination address
//
void NetworkLar1RemoveRequestSent( GlomoNetworkLar1* lar1, NODE_ADDR destAddr );
...
//
BOOL NetworkLar1LookupRequestSeen( LAR1_RequestSeenEntry* reqSeen, NODE_ADDR sourceAddr, int seqNum );
...
//
BOOL NetworkLar1CalculateReqZone( GlomoNode* node, Message* msg, NODE_ADDR destAddr );
...
//
BOOL NetworkLar1BufferPacket( GlomoNode* node, Message* msg, NODE_ADDR destAddr );
...
//
BOOL NetworkLar1PendingRouteReq( GlomoNode* node, NODE_ADDR destAddr );
...
// PARAMETERS   destAddr        - the destination to check
//
BOOL NetworkLar1RouteExists( LAR1_RouteCacheEntry* cacheEntry, NODE_ADDR destAddr );
...
//
LAR1_RouteCacheEntry* NetworkLar1RetrieveCacheEntry( LAR1_RouteCacheEntry* cacheEntry,
                                                     NODE_ADDR destAddr );
...
//
void NetworkLar1SetTimer( GlomoNode* node, long eventType, NODE_ADDR destAddr, clocktype delay );
...
void NetworkLar1RouterFunction( GlomoNode* node,
                                Message* msg,
                                NODE_ADDR destAddr,
...
//
void NetworkLar1InvalidateRoutesThroughBrokenLink( GlomoNode* node,
                                                   NODE_ADDR fromHop,
                                                   NODE_ADDR toHop );
...
//                                have gone
//
void NetworkLar1TransmitErrorPacket( GlomoNode* node, const Message* oldMsg, NODE_ADDR nextHop );
...
//
void NetworkLar1PacketDropNotificationHandler( GlomoNode* node,
                                               const Message* msg,
